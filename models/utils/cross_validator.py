...
class CrossValidator:
    """
    A class for performing cross-validation using different strategies and evaluation metrics.
    ...
    def __init__(self, model, X, y, cv: int = 5, scoring: list = ["roc_auc"], strategy: str = "stratified"):
        """
